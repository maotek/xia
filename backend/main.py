...
QUESTIONS: list[dict[str, Any]] = [
    {
        ...
        "choices": ["Leo", "Cancer", "Gemini", "Pisces"],
        "correct_indices": [1],
    },
    {
        "id": "geboorteplaats",
        ...
        "choices": ["Bergen op Zoom", "Goes", "Eindhoven", "Rotterdam"],
        "correct_indices": [2],
    },
    {
        "id": "eerste-telefoon",
        ...
        "choices": ["iPhone 5s", "Iphone 5c", "Samsung Galaxy S4", "Samsung Galaxy Core"],
        "correct_indices": [3],
    },
    {
        "id": "vroeger-worden",
        ...
        "choices": ["Verpleegkundige", "Dierenarts", "Ijsprinses", "Superheldin"],
        "correct_indices": [1],
    },
    {
        "id": "obsessie-artiest",
        ...
        "choices": ["Justin Bieber", "Ariana Grande", "One Direction", "BTS"],
        "correct_indices": [2],
    },
    {
        "id": "lengte",
    ...
    },
    {
        ...
        "choices": ["Rocky", "Rakker", "Rover", "Rex"],
        "correct_indices": [1],
    },
    {
        "id": "sport",
        ...
        "choices": ["Zwemmen", "Voetbal", "Paardrijden", "Dansen"],
        "correct_indices": [2],
    },
    {
        "id": "telefoon-wc",
        ...
        "choices": ["In de sloot", "Op de stoep", "In de trein", "In de wc"],
        "correct_indices": [3],
    },
    {
        "id": "thuiskomen",
        "kind": "quiz",
        "prompt": "Wat doe ik graag als ik thuis kom?",
        "choices": ["Eten zoeken", "Dutje doen", "Plassen", "Film kijken"],
        "correct_indices": [1],
    },
    {
        "id": "duizend-euro",
        ...
        "choices": ["Kaal gaan", "Feet pics", "Mao slaan", "Mijn haar roze verven"],
        "correct_indices": [3],
    },
    {
        "id": "goud-zilver",
        ...
        "choices": ["Zilver", "Allebei evenveel", "Goud", "Rosegoud"],
        "correct_indices": [2],
    },
    {
        "id": "koffie-thee",
        ...
        "choices": ["Koffie", "Allebei", "Matcha", "Thee"],
        "correct_indices": [3],
    },
    {
        "id": "lucky-number",
    ...
    },
    {
        ...
        "choices": ["Appels", "Stof", "Lactose", "Niets"],
        "correct_indices": [3],
    },
    {
        "id": "middelbare-instrument",
        "kind": "quiz",
        "prompt": "Welk instrument speelde ik tijdens het liedje ''High Hopes'' op de middelbare school?",
    ...
    },
    {
        "id": "kaas",
        "kind": "quiz",
        "prompt": "Wat heb ik het liefst er altijd bij het eten?",
        "choices": ["Augurken", "Kaas", "Mayo", "Laoganma"],
        "correct_indices": [1],
    },
    {
        "id": "niet-lusten",
    ...
    },
    {
        ...
        "choices": ["Japan", "Korea", "Amerika", "Thailand"],
        "correct_indices": [0, 1, 2, 3],
    },
    {
